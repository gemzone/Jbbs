...
{
	public static final Logger logger = LoggerFactory.getLogger(DataRow.class);
...
//	public String getXml(String columnName)
//	{
//		if( this.map.get(columnName) != null )
//		{
//			return "<"+columnName+">" + new Convert( this.map.get(columnName).toString() ).doFilterXMLEscape() + "</"+columnName+">";
//		}
//		else
//		{
...
//	}
//	
//	public String getXmlCDATA(String columnName)
//	{
//		if( this.map.get(columnName) != null )
//		{
//			return "<"+columnName+"><![CDATA[" + this.map.get(columnName).toString() + "]]></"+columnName+">";
//		}
//		else
//		{
//			return "<"+columnName+">" + "" + "</"+columnName+">";
